  ...
  class OBJECTID extends DataTypes.ABSTRACT {
    ...
    _sanitize(value) {
      if (!value || value.length < 24) {
        value = (0, _ObjectID.default)().toString();
      }
    ...
    static defaultValue() {
      return (0, _ObjectID.default)().toString();
    }

  }

  DataTypes.OBJECTID = OBJECTID; // 必须，设定键

  DataTypes.OBJECTID.prototype.key = DataTypes.OBJECTID.key = 'OBJECTID'; // 可选，禁用在字符串化后转义。不建议。
